...
export const name = 'pull-requests-github.rate-limit-error'
...
export const test: Test = async ({ Command, expect, FileSystem, Locator, Workspace }) => {
  ...
  await Command.executeExtensionCommand('PullRequestsGithub.setPullRequestListError', owner, repo, 'open', 'API rate limit exceeded')
