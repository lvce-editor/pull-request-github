...
export const name = 'pull-requests-github.create-signed-out'
export const test: Test = async ({ Command, expect, FileSystem, Locator, Workspace }) => {
  ...
  const fixture = { defaults, responses: [], signedOut: true }
  ...
  await retry(() => expect(element1).toContainText('Sign in'))
