...
export const name = 'pull-requests-github.create-same-branch'
export const test: Test = async ({ Command, expect, FileSystem, Locator, Workspace }) => {
  ...
  const fixture = { defaults: { ...defaults, headBranch: 'main' }, responses: [] }
  ...
  await retry(() => expect(element1).toContainText('must be different'))
