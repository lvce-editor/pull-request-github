...
export const name = 'pull-requests-github.create-detached-head'
export const test: Test = async ({ Command, expect, FileSystem, Locator, Workspace }) => {
  ...
  const fixture = { error: 'Check out a branch before creating a pull request.', responses: [] }
  ...
  await retry(() => expect(element1).toContainText('Check out a branch before creating a pull request.'))
