...
export const name = 'pull-requests-github.create-no-workspace'
export const test: Test = async ({ Command, expect, FileSystem, Locator, Workspace }) => {
  ...
  const fixture = { error: 'Open a workspace first', responses: [] }
  ...
  await retry(() => expect(element1).toContainText('Open a workspace first'))
