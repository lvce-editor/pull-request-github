...
export const name = 'pull-requests-github.create-empty-title'
export const test: Test = async ({ Command, expect, FileSystem, Locator, Workspace }) => {
  ...
  const fixture = { defaults: { ...defaults, title: '' }, responses: [] }
  ...
  await retry(() => expect(element1).toContainText('are required'))
